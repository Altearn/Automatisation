...
execute if score petit_sas_timer general matches 1 positioned 73 4 14 run playsound minecraft:block.piston.contract master @a ~ ~ ~ 1.0 1.0 1.0
execute if score petit_sas_timer general matches 1 run fill 73 4 14 73 5 15 minecraft:black_stained_glass_pane
...
execute if score petit_sas_timer general matches 80 run fill 71 4 12 71 5 12 minecraft:air
execute if score petit_sas_timer general matches 80 run scoreboard players set petit_sas general 20
execute if score petit_sas_timer general matches 80 positioned 71 4 12 run playsound minecraft:block.piston.extend master @a ~ ~ ~ 1.0 1.0 1.0


execute if score petit_sas_timer general matches ..79 run schedule function scripts:sas/sas_petit_4 1t
